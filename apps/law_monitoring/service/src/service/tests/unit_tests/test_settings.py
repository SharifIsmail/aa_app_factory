...
def env_variables() -> Dict[str, str]:
    return {
        ...
        "SERVICE_PHARIA_KERNEL_URL": "http://some-kernel-url.com/",
    }
...
def test_loading_settings_raises_no_error_for_non_required_settings(
    ...
    environ["SERVICE_PHARIA_KERNEL_URL"] = "http://some-kernel-url.com/"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("SERVICE_PHARIA_KERNEL_URL", "www.some-kernel-url.com/"),
    ],
)
